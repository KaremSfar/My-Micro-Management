...
const Navbar = () => {
    return (
        <nav className="flex justify-between items-center bg-white">
            <div className="flex justify-between items-center shadow-md border-2 border-black rounded-xl h-13 p-2 gap-1">
                <Link to="/" className="text-gray-600 p-2 hover:bg-zinc-100 hover:text-gray-950 block rounded-md text-base font-medium">
                ...
                <Link to="/" className="text-gray-600 hover:bg-zinc-100 hover:text-gray-950 block px-2 py-1 rounded-md text-base font-medium">Expensya</Link>
                <Link to="/" className="text-gray-600 hover:bg-zinc-100 hover:text-gray-950 block px-2 py-1 rounded-md text-base font-medium">My Micro Mgmt</Link>
            </div>
            <div className="flex-grow"></div> {/* This div can act as spacer if needed */}
            <div className="flex justify-between items-center shadow-md border-2 border-black rounded-xl h-13 p-2 gap-1">
                <Link to="/" className="flex justify-between items-center text-gray-600 p-2 hover:bg-zinc-100 hover:text-gray-950 block rounded-md text-base font-medium">
