        ...
        <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center border-2 border-slate-200 rounded-xl bg-white shadow-sm">
                <NavLink 
                    to="/analytics" 
                    className={({ isActive }) => 
                        `px-3 py-2 border-r border-slate-200 transition-colors ${
                            isActive ? 'bg-zinc-100' : 'hover:bg-slate-50'
                        }`
                    }
                >
                    <svg viewBox="0 0 40 40" className="w-6 h-6 text-slate-600" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.59375 37.4062H37.4062M2.00962 17.5841L10.5048 10.5048L16.1683 14.7524L35.9903 0.59375V30.3156H2.00965L2.00962 17.5841Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </NavLink>
